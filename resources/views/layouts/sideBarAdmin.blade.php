<nav id="sideBar"
    ...
    <div class="mt-6">
        <h6 class="text-purple-800 text-sm font-bold px-4">Categories</h6>
        <ul class="mt-3">
            <li>
                <a href="/addCategory"
                    class="text-black hover:text-purple-600 text-sm flex items-center hover:bg-purple-50 rounded px-4 py-3 transition-all">
    ...
    <div class="mt-6">
        <h6 class="text-purple-800 text-sm font-bold px-4">Users</h6>
        <ul class="mt-3">

            <li>
                <a href="/manageOrganizer"
                    class="text-black hover:text-purple-600 text-sm flex items-center hover:bg-purple-50 rounded px-4 py-3 transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[18px] h-[18px] mr-4"
                        viewBox="0 0 512 512">
                        <path
    ...
    <div class="mt-6">
        <h6 class="text-purple-800 text-sm font-bold px-4">Actions</h6>
        <ul class="mt-3">
