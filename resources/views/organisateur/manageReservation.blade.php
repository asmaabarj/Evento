            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-100 transition-colors duration-200">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <form action="{{ route('reservation.accept', $reservation->id) }}" method="POST" class="inline-block">
                            @csrf
                            <button type="submit" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 focus:outline-none">Accept</button>
                        </form>
                    </td>
                </tr>
                @endforeach
