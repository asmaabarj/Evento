...
<body class="w-[100%] bg-gray-50">
    ...
    <div class="lg:w-[80%] lg:ml-auto px-7 py-10">
            ...
            <tbody>
                @foreach ($organizers as $organizer)
                    <tr class="border-b hover:bg-gray-100 transition-colors duration-200">
                        ...
                        <td class="lg:px-6 py-4 whitespace-nowrap">{{ $organizer->user->email }}</td>
                        <td class="lg:px-6 py-4 whitespace-nowrap">{{ $organizer->user->phone }} </td>
                        <td class="lg:px-6 py-4 whitespace-nowrap">{{ $organizer->user->created_at }} </td>
